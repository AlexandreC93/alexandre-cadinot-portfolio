        ...
        <main className="mx-auto min-h-screen w-full max-w-4xl px-4 py-10 text-sm text-slate-700 dark:text-slate-200">
            ...
            <header className="space-y-3">
                ...
                <p className="max-w-xl text-slate-600 dark:text-slate-300">
                    Implementation of the dining philosophers problem using threads and
                    mutexes. The goal is to avoid deadlocks and starvation while
                    respecting strict timing rules.
                </p>
                ...
                <div className="mt-6 mb-10 flex items-center">
                    <a
                        href="https://github.com/AlexandreC93/philosophers"
                        target="_blank"
            ...
            <section className="mt-8 space-y-3">
                ...
                <p>
                    Philosophers is a compact but intense introduction to real concurrency
                    issues:
                </p>
